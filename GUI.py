...
#    Oct 04, 2019 12:50:45 AM MST  platform: Windows NT
import sys
...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        top.geometry("865x447+386+327")
        top.title("Blood Analyzer")
        top.configure(background="#d9d9d9")
        
        
        self.healthStatusFrame = tk.LabelFrame(top)
        self.healthStatusFrame.place(relx=0.006, rely=0.0, relheight=0.19
                , relwidth=0.186)
        self.healthStatusFrame.configure(relief='groove')
        self.healthStatusFrame.configure(borderwidth="4")
        self.healthStatusFrame.configure(font=font9)
        ...
        self.statusText.place(relx=0.062, rely=0.235, relheight=0.282, relwidth=0.522
                , bordermode='ignore')
        self.statusText.configure(background="white")
        self.statusText.configure(font="TkTextFont")
        ...
        self.camTempText.place(relx=0.062, rely=0.588, relheight=0.282
                , relwidth=0.211, bordermode='ignore')
        self.camTempText.configure(background="white")
        self.camTempText.configure(font="TkTextFont")
        ...
        self.camTempLabel.place(relx=0.248, rely=0.588, height=26, width=107
                , bordermode='ignore')
        ...
        self.cameraFrame.place(relx=0.202, rely=0.38, relheight=0.145
                , relwidth=0.186)
        self.cameraFrame.configure(relief='groove')
        self.cameraFrame.configure(borderwidth="4")
        self.cameraFrame.configure(font="-family {Segoe UI} -size 9 -weight bold")
        ...
        self.camAdjustButton.place(relx=0.062, rely=0.308, height=32, width=130
                , bordermode='ignore')
        ...
        self.focusFrame.configure(borderwidth="4")
        self.focusFrame.configure(font="-family {Segoe UI} -size 9 -weight bold")
        ...
        self.minusStepFocusButton.place(relx=0.062, rely=0.114, height=32, width=60
                , bordermode='ignore')
        ...
        self.minusStepFocusButton.configure(command=lambda : self.jogDwn());
        
        
        

        self.plusStepFocusButton = tk.Button(self.focusFrame)
        self.plusStepFocusButton.place(relx=0.497, rely=0.114, height=32, width=60
                , bordermode='ignore')
        ...
        self.plusStepFocusButton.configure(command=lambda : self.jogUp());
        ...
        self.focusPosText.configure(font=("TkTextFont",8))
        ...
        self.focusPosLabel.place(relx=0.342, rely=0.343, height=26, width=98
                , bordermode='ignore')
        ...
        self.videoButton.place(relx=0.062, rely=0.543, height=32, width=60
                , bordermode='ignore')
...
#         self.plusStepFocusButton.configure(command=lambda : self.turnOnVideo());
        ...
        self.autoFocusButton.place(relx=0.062, rely=0.743, height=32, width=86
                , bordermode='ignore')
        ...
        self.autoFocusButton.configure(command=lambda : self.autoFocus());


        self.manualFrame = tk.LabelFrame(top)
        self.manualFrame.place(relx=0.405, rely=0.649, relheight=0.342
                , relwidth=0.186)
        self.manualFrame.configure(relief='groove')
        self.manualFrame.configure(borderwidth="4")
        self.manualFrame.configure(font="-family {Segoe UI} -size 9 -weight bold")
        ...
        self.captureImageButton.place(relx=0.062, rely=0.131, height=32, width=130
                , bordermode='ignore')
...
#         self.captureImageButton.configure(command=lambda : self.getImage());
        ...
        self.analyzeSampleButton.place(relx=0.062, rely=0.425, height=32, width=130
                , bordermode='ignore')
        ...
        self.analyzeSampleButton.configure(command=lambda : self.countBlood());

        self.saveDataButton = tk.Button(self.manualFrame)
        self.saveDataButton.place(relx=0.062, rely=0.719, height=32, width=130
                , bordermode='ignore')
        ...
        self.saveDataButton.configure(command=lambda : self.saveData());
        ...
        self.utilityFrame.configure(borderwidth="4")
        self.utilityFrame.configure(font="-family {Segoe UI} -size 9 -weight bold")
        ...
        self.createFileButton.place(relx=0.062, rely=0.095, height=32, width=130
                , bordermode='ignore')
        ...
        self.openFileButton.place(relx=0.062, rely=0.31, height=32, width=130
                , bordermode='ignore')
        ...
        self.setPathologyButton.place(relx=0.062, rely=0.524, height=32, width=130
                , bordermode='ignore')
        ...
        self.minPathologyText.configure(font="TkTextFont")
        ...
        self.maxPathologyText.configure(font="TkTextFont")
        ...
        self.minPathologyLabel.place(relx=0.124, rely=0.714, height=16, width=31
                , bordermode='ignore')
        ...
        self.maxPathologyLabel.place(relx=0.559, rely=0.714, height=16, width=42
                , bordermode='ignore')
        ...
        self.automaticFrame.place(relx=0.607, rely=0.649, relheight=0.342
                , relwidth=0.186)
        self.automaticFrame.configure(relief='groove')
        self.automaticFrame.configure(borderwidth="4")
        self.automaticFrame.configure(font="-family {Segoe UI} -size 9 -weight bold")
        ...
        self.autoStartButton.place(relx=0.062, rely=0.131, height=32, width=130
                , bordermode='ignore')
        ...
        self.emergencyStopButton.place(relx=0.062, rely=0.49, height=60, width=130
                , bordermode='ignore')
        ...
        self.emergencyStopButton.configure(font=font9)
        ...
        self.illuminatorFrame.place(relx=0.006, rely=0.179, relheight=0.483
                , relwidth=0.186)
        self.illuminatorFrame.configure(relief='groove')
        self.illuminatorFrame.configure(borderwidth="4")
        self.illuminatorFrame.configure(font="-family {Segoe UI} -size 9 -weight bold")
        ...
        self.ledPowerButton.place(relx=0.062, rely=0.093, height=32, width=60
                , bordermode='ignore')
        ...
        self.ledPowerButton.configure(command=lambda : self.ledOn())
        ...
        self.redLevelText.configure(font="TkTextFont")
        ...
        self.greenLevelText.configure(font="TkTextFont")
        ...
        self.blueLevelText.configure(font="TkTextFont")
        ...
        self.ledSetButton.place(relx=0.062, rely=0.81, height=32, width=60
                , bordermode='ignore')
        ...
        self.redLevelLabel.place(relx=0.373, rely=0.278, height=26, width=75
                , bordermode='ignore')
        ...
        self.greenLevelLabel.place(relx=0.373, rely=0.463, height=26, width=89
                , bordermode='ignore')
        ...
        self.blueLevelLabel.place(relx=0.373, rely=0.648, height=26, width=84
                , bordermode='ignore')
        ...
        self.carouselFrame.place(relx=0.006, rely=0.66, relheight=0.331
                , relwidth=0.186)
        self.carouselFrame.configure(relief='groove')
        self.carouselFrame.configure(borderwidth="4")
        self.carouselFrame.configure(font="-family {Segoe UI} -size 9 -weight bold")
        ...
        self.minusStepCarouselButton.place(relx=0.062, rely=0.135, height=32, width=60
                , bordermode='ignore')
        ...
        self.plusStepCarouselButton.place(relx=0.497, rely=0.135, height=32, width=60
                , bordermode='ignore')
        ...
        self.zeroCarouselButton.place(relx=0.062, rely=0.439, height=32, width=60
                , bordermode='ignore')
        ...
        self.goToSlideText.configure(font="TkTextFont")
        ...
        self.goToSlideButton.place(relx=0.435, rely=0.709, height=32, width=83
                , bordermode='ignore')
        ...
        self.sampleParamsFrame.place(relx=0.809, rely=0.649, relheight=0.342
                , relwidth=0.186)
        self.sampleParamsFrame.configure(relief='groove')
        self.sampleParamsFrame.configure(borderwidth="4")
        self.sampleParamsFrame.configure(font="-family {Segoe UI} -size 9 -weight bold")
        ...
        self.sampleIdText.configure(font="TkTextFont")
        ...
        self.sampleDateText.configure(font=("TkTextFont",8))
        ...
        self.sampleRatioText.configure(font=("TkTextFont",8))
        ...
        self.sampleIdLabel.place(relx=0.373, rely=0.131, height=24, width=85
                , bordermode='ignore')
        ...
        self.sampleDateLabel.place(relx=0.404, rely=0.327, height=24, width=40
                , bordermode='ignore')
        ...
        self.sampleRatioLabel.place(relx=0.404, rely=0.523, height=24, width=80
                , bordermode='ignore')
        ...
        self.sampleBloodCountText.configure(font=("TkTextFont",8))
        ...
        self.sampleBloodCountLabel.place(relx=0.435, rely=0.752, height=24, width=49
                , bordermode='ignore')
        ...
        self.imageFrame.place(relx=0.39, rely=0.015, relheight=0.638
                , relwidth=0.608)
        self.imageFrame.configure(relief='groove')
        self.imageFrame.configure(borderwidth="4")
#         self.imageFrame.configure(font="-family {Segoe UI} -size 9 -weight bold")
